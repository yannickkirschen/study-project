...
\definecolor{CIdentifier}{HTML}{342176}
...
\lstdefinelanguage{C}{
    ...
    moredelim=*[directive]\#,
    stringstyle=\color{String},
    morekeywords={auto, break, bool, case, char, const, continue, default, do, double, else, enum, extern, float, for, goto, if, int, long, register, return, short, signed, sizeof, static, struct, switch, typedef, union, unsigned, void, volatile, while},
    keywordstyle=\color{Keyword},
    ...
    moreidentifier={rail_contact_point_t,rail_contact_point_directed_t}
}
