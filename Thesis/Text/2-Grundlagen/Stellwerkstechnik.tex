...
\begin{figure}[H]
    ...
    \subfloat[\centering Formsignale]{{
        \includegraphics[width=.40\textwidth]{Assets/Images/2-Grundlagen/Formsignale.jpg}
    }}
    \qquad
    \subfloat[\centering Lichtsignal]{{
        \includegraphics[width=.40\textwidth]{Assets/Images/2-Grundlagen/Ks-Signal.jpg}
    }}
