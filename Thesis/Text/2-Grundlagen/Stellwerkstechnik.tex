...
\begin{figure}[H]
    \centering
    \subfloat[\centering Formsignale~\cite{bib:bild:wiki:Formsignale}]{{
        \includegraphics[width=.4\textwidth]{Assets/Images/2-Grundlagen/Formsignale.jpg}
    }}
    \qquad
    \subfloat[\centering Lichtsignal~\cite{bib:bild:wiki:Ks-Signal}]{{
...
\begin{figure}[H]
    ...
    \caption{Ausschnitt aus einer beispielhaften Stelltafel~\cite{bib:bild:wiki:Stelltafel-Auschnitt}}\label{abb:Grundlagen:Stellwerkstechnik:Relaisstellwerke:Stelltafel-Ausschnitt}
\end{figure}
